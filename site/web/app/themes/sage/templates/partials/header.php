<header class="banner" <?php echo (!is_front_page()) ? 'style="
    height: 236px;
    background-image: url(//posvisualsolutions.dev/app/uploads/2016/10/banner-image.jpg);
    background-position: top center !important;
    background-size: cover !important;
"':'';?> >
  <section class="top-header">
    <div class="container">
      <aside class="logo-bg hidden-md-down">
  ...
  <nav class="navbar navbar-dark bg-inverse hidden-md-down">
    <?php
